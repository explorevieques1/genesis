...
status: built
implemented_by: [src/genesis/charting/spec.py, src/genesis/charting/store.py, tests/charting/test_spec.py, tests/charting/test_store_and_outcomes.py, src/genesis/charting/timeframes.py]
---
